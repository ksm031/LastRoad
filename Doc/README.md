...
**버전**: 1.4 (원본 2026-04-16) | **상태**: 리빙 문서 | **최근 변경**: 갓길 수색 시스템 추가
...
| [06-threats.md](06-threats.md) | 자연 위협·컬트 위협·환각 위협 카테고리, 컬트 AI, 사슴머리(보스) | 도로 위협·적 AI 관련 작업 |
...
- **"컬트는 언제 움직이지?"** → [06-threats.md](06-threats.md)
